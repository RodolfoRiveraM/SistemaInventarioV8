    ...
    public class ProductoController : Controller
    {
        ...
        public async Task<IActionResult> Upsert(int? id)
        {
            ProductoVM productoVM = new ProductoVM()
            {
                ...
                CategoriaLista = _unidadTrabajo.Producto.ObtenerTodsDropdownLista("Categoria"),
                MarcaLista = _unidadTrabajo.Producto.ObtenerTodsDropdownLista("Marca"),
                PadreLista = _unidadTrabajo.Producto.ObtenerTodsDropdownLista("Producto")
            };
        ...
        public async Task<IActionResult> Upsert(ProductoVM productoVM)
        {
            ...
            productoVM.CategoriaLista = _unidadTrabajo.Producto.ObtenerTodsDropdownLista("Categoria");
            productoVM.MarcaLista = _unidadTrabajo.Producto.ObtenerTodsDropdownLista("Marca");
            productoVM.PadreLista = _unidadTrabajo.Producto.ObtenerTodsDropdownLista("Producto");
            return View(productoVM);
        }
